...
import { env } from '../../env'
import { listSkills, loadSkill, activateSkillMcp, executeMcpTool, deactivateSkillMcp, runContainerCommand } from '../tools'
...
export const executionAgent = new Agent({
  ...
  tools: { listSkills, loadSkill, activateSkillMcp, executeMcpTool, deactivateSkillMcp, runContainerCommand },
})
